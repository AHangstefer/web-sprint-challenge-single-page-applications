...
useRouteMatch is used in a child component to get url and path properties 


1. How would you explain form validation to someone who has never programmed before?

Validation is used to make sure that when someone is interacting with elements on a page, the effects the elements trigger are functioning correctly. 

1. In 1-2 sentences, define end to end testing.

End to end testing is used to test the flow of an application from start to finish, to ensure it's behaving as it's intended. 
